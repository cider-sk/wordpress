...
<html lang="ja">
  <head>
    ...
    <link href="<?php bloginfo("template_url"); ?>/used_carshop.css" rel="stylesheet">
    <link href="<?php bloginfo("template_url"); ?>/element_goo.css" rel="stylesheet">
    <link href="<?php bloginfo("template_url"); ?>/element_tpl_goo.css" rel="stylesheet">
    <link href="<?php bloginfo("template_url"); ?>/base_goo.css" rel="stylesheet">
    <link href="<?php bloginfo("template_url"); ?>/detail_goo.css" rel="stylesheet">
    <link href="<?php bloginfo("template_url"); ?>/campagin_goo.css " rel="stylesheet">
    <link href="<?php bloginfo("template_url"); ?>/staff_goo.css" rel="stylesheet">

    <link href="<?php bloginfo("template_url"); ?>/style.css" rel="stylesheet">

        <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]><script src="<?php bloginfo("template_url"); ?>/assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
    ...
    <div class="container">
        ...
        <div id="menu">
            <div class="hukidashi">
                ...
                <span><img src="<?php bloginfo("url") ?>/wp-content/uploads/2015/09/吹き出し（60秒で完了）.png" alt=""></span>
                <span class="right"><img src="<?php bloginfo("url") ?>/wp-content/uploads/2015/09/吹き出し（中古車を売る？）.png" alt=""></span>
            </div>
